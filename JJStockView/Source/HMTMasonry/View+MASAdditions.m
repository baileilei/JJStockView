...
- (NSArray *)mas_makeConstraints:(void(^)(HMTMASConstraintMaker *))block {
    self.translatesAutoresizingMaskIntoConstraints = NO;
    HMTMASConstraintMaker *constraintMaker = [[HMTMASConstraintMaker alloc] initWithView:self];
    block(constraintMaker);
    return [constraintMaker install];
}

- (NSArray *)mas_updateConstraints:(void(^)(HMTMASConstraintMaker *))block {
    self.translatesAutoresizingMaskIntoConstraints = NO;
    HMTMASConstraintMaker *constraintMaker = [[HMTMASConstraintMaker alloc] initWithView:self];
...
- (NSArray *)mas_remakeConstraints:(void(^)(HMTMASConstraintMaker *make))block {
    self.translatesAutoresizingMaskIntoConstraints = NO;
    HMTMASConstraintMaker *constraintMaker = [[HMTMASConstraintMaker alloc] initWithView:self];
